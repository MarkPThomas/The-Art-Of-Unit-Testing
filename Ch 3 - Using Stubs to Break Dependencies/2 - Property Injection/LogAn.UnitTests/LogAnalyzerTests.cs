...
namespace LogAn.UnitTests
{
    ...
    public class LogAnalyzerTests
    {
        ...
        public void SetUp()
        {
            ...
            ////////////////
            // Using Constructor Injection with Factory Method
            ////////////////
            // Note that in this case, the state needs to be hardwired in, so a new instance must be created for each change in manager behavior.
                                         ...
                                         Exception managerThrows = null)
        {
            ...
            LogAnalyzer myLogAnalyzer = new LogAnalyzer();
            myLogAnalyzer.Manager = myFakeManager;

            return myLogAnalyzer;
        }
    }
}
